...
public class BucketLifecycleTest extends TestBase {
    ...
    @Test
    public void testNormalSetBucketLifecycle_AccessMonitor() throws ParseException {
        final String bucketName = super.bucketName + "normal-set-bucket-lifecycle-am";
        final String ruleId0 = "delete obsoleted files";
        final String matchPrefix0 = "obsoleted0/";
        final String ruleId1 = "delete temporary files";
        final String matchPrefix1 = "temporary0/";
    ...
    @Test
    public void testUnormalSetBucketLifecycle_AccessMonitor() throws ParseException {
        final String bucketName = super.bucketName + "unormal-set-bucket-lifecycle-am";
        final String ruleId0 = "delete obsoleted files";
        final String matchPrefix0 = "obsoleted/";
        final String nonexistentBucket = "nonexistent-bucket";
        try {
